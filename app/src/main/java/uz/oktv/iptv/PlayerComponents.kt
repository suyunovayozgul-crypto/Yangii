        ...
        object : Player.Listener {
            ...
            override fun onPlayerError(
                ...
                if (
                    ...
                    // BEHIND_LIVE_WINDOW'dan boshqa har qanday xato
                    // (tarmoq uzilishi, server javob bermasligi va h.k.)
                    // — avval bunday hollarda ekran abadiy muzlab qolardi,
                    // chunki qayta urinish faqat yuqoridagi bitta xato turi
                    // uchun ishlar edi. Endi shu yerda ham qayta uriniladi.
                    ...
                    if (now - lastRecoveryTime >= 10000L) {
                        ...
                        Log.w(
                            "OKTV_WATCHDOG",
                            "PLAYER ERROR (${error.errorCodeName}) -> RETRY IN 2s"
                        )
                        ...
                        Handler(Looper.getMainLooper()).postDelayed({
                            try {
                                ...
                                Log.w(
                                    "OKTV_WATCHDOG",
                                    "GENERIC ERROR -> REPREPARE PLAY"
                                )
                            } catch (e: Exception) {
                                Log.e(
                                    "OKTV_WATCHDOG",
                                    "GENERIC ERROR -> REPREPARE FAILED",
                                    e
                                )
                            } finally {
                                recoveryInProgress = false
