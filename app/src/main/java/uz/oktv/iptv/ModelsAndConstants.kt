...
object Strings {
    private val translations = mapOf(
        ...
        "speed_test_title" to mapOf(AppLang.RU to "Тест скорости сети OKTV", AppLang.UZ to "OKTV tarmoq tezligi testi", AppLang.EN to "OKTV Speed Test", AppLang.UK to "Тест швидкості мережі OKTV", AppLang.TR to "OKTV Hız Testi"),
